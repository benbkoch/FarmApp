...
public class Farm {
	...
	protected void createContents() {
		...
		button_1.setBounds(148, 292, 96, 23);
		...
		button_2.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				patient.addPrescription(new Prescription(drugNameBox.getText(),
						drugDoseBox.getText(), drugInstructionsBox.getText()));
		...
		button_2.setBounds(463, 29, 114, 23);
		...
		TableColumn tblclmnDrug = new TableColumn(table, SWT.NONE);
		tblclmnDrug.setWidth(100);
		tblclmnDrug.setText("Drug");

		TableColumn tblclmnFulfilled = new TableColumn(table, SWT.NONE);
		tblclmnFulfilled.setWidth(100);
		tblclmnFulfilled.setText("Fulfilled?");

		TableColumn tblclmnPickedup = new TableColumn(table, SWT.NONE);
		...
		btnNewButton.setBounds(489, 358, 105, 23);
		btnNewButton.setText("Mark Picked Up");
